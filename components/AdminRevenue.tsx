...
import { getTransactions, getOrders } from '../services/mockService';
...
export const AdminRevenue: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Mock chart data generation (Group by date)
    const data = [
      { name: 'Mon', revenue: revenue * 0.1, invested: invested * 0.2 },
      { name: 'Tue', revenue: revenue * 0.2, invested: invested * 0.1 },
      { name: 'Wed', revenue: revenue * 0.15, invested: invested * 0.1 },
      { name: 'Thu', revenue: revenue * 0.25, invested: invested * 0.3 },
      { name: 'Fri', revenue: revenue * 0.3, invested: invested * 0.3 },
    ];
    setChartData(data);
